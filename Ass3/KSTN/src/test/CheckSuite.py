...
class CheckSuite(unittest.TestCase):
        ...
        input = """
                ...
                Function: main
                    Body:
                        ...
                        x[1][3\\-0] = 1;
                    EndBody."""
        expect = "Index Out Of Range: ArrayCell(Id(x),[IntLiteral(1),BinaryOp(\,IntLiteral(3),UnaryOp(-,IntLiteral(0)))])"
    ...
    def test_invalid_array_literal_01(self):
        input = """ Var: x[2][2] = {{1,1},{1,1}};
                    Function: main
                    Body:
                    EndBody.
                """
    ...
    def test_invalid_array_literal_02(self):
        input = """ Var: x[2][2] = {{1,1},1};
                    Function: main
                    Body:
                    EndBody.
                """
        expect = str(InvalidArrayLiteral(ArrayLiteral([ArrayLiteral([IntLiteral(1),IntLiteral(1)]),IntLiteral(1)])))
        self.assertTrue(TestChecker.test(input,expect,535))

    def test_invalid_array_literal_03(self):
        input = """ Var: x[2][2] = {{1,1},{1,1,1}};
                    Function: main
                    Body:
                    EndBody.
                """
    ...
    def test_invalid_array_literal_04(self):
        input = """ Var: x[2] = {"hello",1};
                    Function: main
                    Body:
                    EndBody.
                """
        expect = str(InvalidArrayLiteral(ArrayLiteral([StringLiteral("hello"),IntLiteral(1)])))
        self.assertTrue(TestChecker.test(input,expect,537))

    def test_invalid_array_literal_05(self):
        input = """ Var: x[1][3] = {{"hi","hello",1}};
                    Function: main
                    Body:
                    EndBody.
                """
        expect = str(InvalidArrayLiteral(ArrayLiteral([StringLiteral("hi"),StringLiteral("hello"),IntLiteral(1)])))
        self.assertTrue(TestChecker.test(input,expect,538))

    def test_invalid_array_literal_06(self):
        input = """ Var: x[1][2] = {{0x20,2.}};
                    Function: main
                    Body:
                    EndBody.
                """
        expect = str(InvalidArrayLiteral(ArrayLiteral([IntLiteral(32),FloatLiteral(2.0)])))
        self.assertTrue(TestChecker.test(input,expect,539))

    def test_invalid_array_literal_07(self):
        input = """ Var: x[2][2] = {{1,2},{1,1.}};
                    Function: main
                    Body:
                    EndBody.
                """
    ...
    def test_invalid_array_literal_08(self):
        input = """ Var: x[3][3] = {{1,2,3},{4,5,6},{8,9,{10}}};
                    Function: main
                    Body:
                    EndBody.
                """
        expect = str(InvalidArrayLiteral(ArrayLiteral([IntLiteral(8),IntLiteral(9),ArrayLiteral([IntLiteral(10)])])))
        self.assertTrue(TestChecker.test(input,expect,541))

    def test_invalid_array_literal_09(self):
        input = """ Var: x[3][3] = {{1,2,3},{4,5,6},{8,9,10,11}};
                    Function: main
                    Body:
                    EndBody.
                """
        expect = str(InvalidArrayLiteral(ArrayLiteral([ArrayLiteral([IntLiteral(1),IntLiteral(2),IntLiteral(3)]),ArrayLiteral([IntLiteral(4),IntLiteral(5),IntLiteral(6)]),ArrayLiteral([IntLiteral(8),IntLiteral(9),IntLiteral(10),IntLiteral(11)])])))
        self.assertTrue(TestChecker.test(input,expect,542))

    def test_invalid_array_literal_10(self):
        input = """ Var: x[2][1][1][1][1] = {{{{{1}}}},{{{{1}}}}};
                    Function: main
                    Body:
                    EndBody.
                """
    ...
    def test_unreachable_function_01(self):
        input = """ Function: main
                    Parameter: a, b
                    Body:
                        a = 1;
    ...
    def test_unreachable_function_02(self):
        input = """ Function: foo
                    Body: 
                    EndBody.
    ...
    def test_unreachable_function_03(self):
        input = """ Function: foo
                    Body: 
                    EndBody.
    ...
    def test_unreachable_function_04(self):
        input = """ Function: foo
                    Body: 
                        main();
                    EndBody.
    ...
    def test_unreachable_function_05(self):
        input = """ Function: foo
                    Body: 
                        Return 1;
                    EndBody.
    ...
    def test_unreachable_function_06(self):
        input = """ Function: f1
                    Body: 
                        f2();
                    EndBody.
    ...
    def test_unreachable_function_07(self):
        input = """ Function: f1
                    Body: 
                        f2();
                    EndBody.
                    ...
                    EndBody.
                """
        expect = str(UnreachableFunction("f1"))
        self.assertTrue(TestChecker.test(input,expect,550))

    def test_unreachable_function_08(self):
        input = """ Function: f1
                    Body: 
                        f1();
                    EndBody.
    ...
    def test_unreachable_function_09(self):
        input = """ Function: main
                    Body:
                        f1();
                    EndBody.
    ...
    def test_unreachable_function_10(self):
        input = """ Function: f1
                    Body:
                    EndBody.
                    ...
                    EndBody.
                """
        expect = str(UnreachableFunction("f3"))
        self.assertTrue(TestChecker.test(input,expect,553))

    """-----------------------------------------------------------------------------------------------------------------------------------------------------------"""

    def test_function_not_return_01(self):
        input = """ Function: main
                    Body:
                    EndBody.
                """
    ...
    def test_function_not_return_02(self):
        input = """ Function: main
                    Body:
                        If True Then 
                            Return 5;
    ...
    def test_function_not_return_03(self):
        input = """ Function: main
                    Body: 
                        If True Then
                            Return 5;
    ...
    def test_function_not_return_04(self):
        input =  """ Function: main
                    Body: 
                        If True Then
                            Return 5;
    ...
    def test_function_not_return_05(self):
        input = """ Function: main
                    Body: 
                        Var: i;
                        For (i = 1, i < 2, 1) Do
    ...
    def test_function_not_return_07(self):
        input = """ Function: main
                    Body: 
                        foo();
                    EndBody.
    ...
    def test_function_not_return_08(self):
        input = """ Function: main
                    Parameter: x, y
                    Body: 
                        If x > 5 Then
    ...
    def test_function_not_return_09(self):
        input = """ Function: main
                    Parameter: x, y
                    Body: 
                        If x > 5 Then
    ...
    def test_unreachable_statement_01(self):
        input = """ Function: main
                    Body: 
                        Return;
                        x = 5;
                    EndBody.
                """
        expect = str(UnreachableStatement(Assign(Id("x"),IntLiteral(5))))
        self.assertTrue(TestChecker.test(input,expect,564))

    def test_unreachable_statement_02(self):
        input = """ Function: main
                    Body: 
                        Var: i;
                        For (i = 1, i < 10, 1) Do
                    ...
                    EndBody.
                """
        expect = str(UnreachableStatement(Assign(Id("i"),IntLiteral(5))))
        self.assertTrue(TestChecker.test(input,expect,565))

    def test_unreachable_statement_03(self):
        input = """ Function: main
                    Body: 
                        Var: i;
                        For (i = 1, i < 10, 1) Do
    ...
    def test_unreachable_statement_04(self):
        input = """ Function: main
                    Body: 
                        Var: i;
                        For (i = 1, i < 10, 1) Do
    ...
    def test_unreachable_statement_05(self):
        input = """ Function: main
                    Body: 
                        Var: i;
                        For (i = 1, i < 10, 1) Do
    ...
    def test_unreachable_statement_06(self):
        input = """ Function: main
                    Body: 
                        Var: i = 5;
                        If i > 10 Then 
    ...
    def test_unreachable_statement_07(self):
        input = """ Function: main
                    Body: 
                        Var: i = 5;
                        If i > 10 Then 
    ...
    def test_unreachable_statement_08(self):
        input = """ Function: main
                    Body: 
                        Var: i = 5;
                        For (i = 1, i < 5, 1) Do
    ...
    def test_unreachable_statement_09(self):
        input = """ Function: main
                    Body: 
                        Var: i = 5;
                        For (i = 1, i < 5, 1) Do
    ...
    def test_index_out_of_range_01(self):
        input = """ Function: main
                    Parameter: x[1][2]
                    Body: 
                        x[-1][1] = 5;
                    EndBody.
                """
        expect = str(IndexOutOfRange(ArrayCell(Id("x"),[UnaryOp("-",IntLiteral(1)),IntLiteral(1)])))
        self.assertTrue(TestChecker.test(input,expect,574))
    
    def test_index_out_of_range_02(self):
        input = """ Function: main
                    Parameter: x[1][2]
                    Body: 
                        x[1][1] = 5;
                    EndBody.
                """
        expect = str(IndexOutOfRange(ArrayCell(Id("x"),[IntLiteral(1),IntLiteral(1)])))
        self.assertTrue(TestChecker.test(input,expect,575))

    def test_index_out_of_range_03(self):
        input = """ Function: main
                    Parameter: x[2][2]
                    Body: 
                        Var: n;
                    ...
                    EndBody.
                """
        expect = str(IndexOutOfRange(ArrayCell(Id("x"),[BinaryOp("-",IntLiteral(2),IntLiteral(3)),Id("n")])))
        self.assertTrue(TestChecker.test(input,expect,576))

    def test_index_out_of_range_04(self):
        input = """ Function: main
                    Parameter: x[2][2]
                    Body: 
                        Var: n;
    ...
    def test_index_out_of_range_05(self):
        input = """ Function: main
                    Parameter: x[2][2]
                    Body: 
                        Var: n;
    ...
    def test_index_out_of_range_06(self):
        input = """ Function: main
                    Parameter: x[2][2]
                    Body: 
                        Var: n;
                    ...
                    EndBody.
                """
        expect = str(IndexOutOfRange(ArrayCell(Id("x"),[BinaryOp("\\",BinaryOp("*",IntLiteral(3),IntLiteral(4)),IntLiteral(5)),Id("n")])))
        self.assertTrue(TestChecker.test(input,expect,579))

    def test_index_out_of_range_07(self):
        input = """ Function: main
                    Parameter: x[2][2]
                    Body: 
                        Var: n, y[2][2] = {{1,2},{3,4}};
                    ...
                    EndBody.
                """
        expect = str(IndexOutOfRange(ArrayCell(Id("x"),[Id("n"),IntLiteral(2)])))
        self.assertTrue(TestChecker.test(input,expect,580))
    
    def test_index_out_of_range_08(self):
        input = """ Function: main
                    Parameter: x[2][2]
                    Body: 
                        Var: n, y[2][2] = {{1,2},{3,4}};
    ...
    def test_index_out_of_range_09(self):
        input = """ Function: main
                    Parameter: x[2][2][1][1]
                    Body: 
                        Var: n, y[2][2] = {{1,2},{3,4}};
    ...
    def test_index_out_of_range_10(self):
        input = """ Function: main
                    Parameter: x[2][2][1][1]
                    Body: 
                        x[-1+2][-2+3][(10*100-10)\\990+(1000%10)-1][0] = 1;
                    EndBody.
                """
        expect = ""
    ...
    def test_more_3(self):
        input = """ Function: main
                    ...
                    EndBody.
                """
        expect = "Function Not Return: main"
