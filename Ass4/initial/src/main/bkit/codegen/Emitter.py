...
class Emitter():
    ...
    *    @param typ the type of the constant
    ...
    def emitASTORE(self, in_, frame):
        ...
        elif type(in_) is cgen.ArrayType or type(in_) is cgen.ClassType or type(in_) is cgen.StringType or type(in_) is cgen.ArrayGen:
    ...
    *   @param toLabel the ending label  of the scope where the variable is active.
    ...
    def emitREADVAR(self, name, inType, index, frame):
        ...
        elif type(inType) is cgen.ArrayType or type(inType) is cgen.ClassType or type(inType) is cgen.StringType or type(inType) is cgen.ArrayGen:
    ...
    *   @param in the type of the returned expression.
    ...
    def emitRETURN(self, in_, frame):
        ...
        if type(in_) is cgen.VoidType: return self.jvm.emitRETURN()

        frame.pop()
        if type(in_) in [cgen.IntType, cgen.BoolType]: return self.jvm.emitIRETURN()
        if type(in_) is cgen.FloatType: return self.jvm.emitFRETURN()
